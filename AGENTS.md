...
| 路径或功能                                                                                                                                       | 必读规则                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| `apps/game002v2`、`assets/crave`、`assets/gamecfg002`                                                                                            | `docs/agent-rules/game002.md`、`docs/agent-rules/shared-game-runtime.md`、`docs/agent-rules/loading-ui.md`                  |
| `apps/game003v2`、`assets/minecart2`、`assets/gamecfg003`                                                                                        | `docs/agent-rules/game003.md`、`docs/agent-rules/shared-game-runtime.md`、`docs/agent-rules/loading-ui.md`                  |
...
| `apps/imgnumbereditor`、`popupeditor`、`symbolseditor`、`apps/editordemo`、`packages/editorcore`、`packages/editorresource`、`browserartifactio` | `docs/agent-rules/editor-artifacts.md`                                                                                      |

...
| 路径或功能                                                                                             | 必读规则                                                                                                                    |
| ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| `apps/game002`、`apps/game002v2`、`assets/game002-*`、`assets/gamecfg002`                              | `docs/agent-rules/game002.md`、`docs/agent-rules/shared-game-runtime.md`、`docs/agent-rules/loading-ui.md`                  |

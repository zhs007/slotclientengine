...
| 路径或功能                                                                                                                                       | 必读规则                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| `assets/gamecfg002`                                                                                                                              | `docs/agent-rules/game002.md`、`docs/agent-rules/shared-game-runtime.md`、`docs/agent-rules/loading-ui.md`                  |
| `assets/gamecfg003`                                                                                                                              | `docs/agent-rules/game003.md`、`docs/agent-rules/shared-game-runtime.md`、`docs/agent-rules/loading-ui.md`                  |

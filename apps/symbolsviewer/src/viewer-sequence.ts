...
export const VIEWER_STATE_ORDER = Object.freeze(["normal", "appear", "win", "spinBlur", "disabled"]);

export const DEFAULT_VIEWER_SEQUENCE: readonly SymbolSequenceStep[] = Object.freeze([
...
export function replaceSequenceStep(
  ...
  return Object.freeze(steps.map((current, currentIndex) => (currentIndex === index ? step : current)));
}
...
export function removeSequenceStep(
  ...
  return Object.freeze(steps.filter((_step, currentIndex) => currentIndex !== index));
}

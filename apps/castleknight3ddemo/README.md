...
旗帜、吊灯、火把和可交互的老虎机风格 HUD。场景模型主要由代码生成，板凳、木桶、战斧、剑、王座台阶、王座、墙体、立柱和吊灯使用压缩后的外部 GLB，
墙面、地面、木材与织物使用项目内的
...
壁挂火把，以及魔法书、王冠两个棋盘符号，均按 img2threejs 的
...
外部 GLB 板凳、木桶、战斧、剑、王座台阶、王座、墙体、立柱和吊灯始终显示模型自带的 PBR 材质。

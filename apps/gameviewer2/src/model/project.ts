...
export interface GameViewer2ProjectFileV1 {
  readonly kind: "gameviewer2-project";
  readonly version: 1;
  readonly layoutSha256: string;
  readonly flow: SceneOtherSceneFlowProjectV1;
}

export function parseGameViewer2ProjectFile(
  input: unknown,
): GameViewer2ProjectFileV1 {
  ...
  if (record.kind !== "gameviewer2-project" || record.version !== 1)
    throw new Error("不是 Game Viewer 2 v1 项目文件。");
  if (
...
export function downloadProject(project: GameViewer2ProjectFileV1): void {

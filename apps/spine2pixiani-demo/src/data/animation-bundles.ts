...
export const animationBundles: AnimationBundle[] = [
  ...
  },
  {
    ...
    description:
      "12 号资源组，包含 bonus1-5 与 fg1-3，并使用 shear 与 drawOrder。",
  },
];
...
export function getAnimationBundle(bundleId: string) {
  return (
    animationBundles.find((bundle) => bundle.id === bundleId) ??

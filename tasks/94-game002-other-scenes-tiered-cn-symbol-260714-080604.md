...
| `CI=true pnpm --filter game002 test`                                                                                                                                                     | 通过，16 files / 84 tests                                                      |
| `CI=true pnpm --filter game002 exec vitest run tests/loading-resources.test.ts`                                                                                                          | 通过，1 file / 5 tests；覆盖发布 URL 合并、重复 ID 与缺失 URL                  |

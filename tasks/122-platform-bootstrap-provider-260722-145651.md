...
| `platformbootstrap-leo` |   19/19 |     88.96% |   83.92% | 通过 |
...
新增 5 项回归测试，重新通过 platformbootstrap-leo 19/19 tests、game002 102/102 tests、lint、typecheck、format check、release check；game003 136/136 tests 与 release check 保持通过。

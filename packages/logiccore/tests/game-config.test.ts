...
describe('createGameConfig', () => {
  it('parses the generated gameconfig fixture', () => {
    ...
    expect(gameConfig.getPaytableEntry(1)).toMatchObject({ code: 1, symbol: 'S00' });
  ...
  it('does not let source or returned data mutate internal state', () => {
    ...
    tryMutate(() => (((gameConfig.getRawConfig() as any).reels.reels01[0] as number[])[1] = 999));
    tryMutate(() => ((gameConfig.getPaytableEntry(1)?.pays as number[])[0] = 999));

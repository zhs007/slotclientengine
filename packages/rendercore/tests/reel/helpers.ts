import { createGameConfig, LogicReelsModel, type LogicReels } from "@slotclientengine/logiccore";
...
export const basicGameConfig = Object.freeze({
  paytable: Object.freeze({
    "0": Object.freeze({ code: 0, symbol: "BN", pays: Object.freeze([0, 0, 0]) }),
    "1": Object.freeze({ code: 1, symbol: "A", pays: Object.freeze([1, 2, 3]) }),
    "2": Object.freeze({ code: 2, symbol: "B", pays: Object.freeze([2, 3, 4]) }),
    "3": Object.freeze({ code: 3, symbol: "C", pays: Object.freeze([3, 4, 5]) })
  }),
...
export function createBasicAssets(overrides: Partial<SymbolAssetMap> = {}): SymbolAssetMap {
  return Object.freeze({

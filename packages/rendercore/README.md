...
renderer 支持原子的 `setText()`、`setAnchor()`、logical/visual snapshot 和 sprite 复用，不创建 `Application`、canvas、DOM、RAF 或字体 fallback。完整 schema、公式、ZIP 与生命周期示例见 [`docs/image-string-manifest.md`](../../docs/image-string-manifest.md)。

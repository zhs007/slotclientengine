...
const requiredExports = [
  ...
  "export interface VNIParticleComboAnimationDescriptor",
  ...
  "export interface V5GCocosPlayerPool",
  "export interface V5GCocosNodeDriver",
  "export interface V5GCocosNodeCaptureOptions",
  "export interface V5GCocosCapturedNodeVisual",
  "export type V5GCocosRuntimeAnimationCapability",
  "export interface V5GCocosAnimationRuntimeRef",
  "export interface V5GCocosManualPlaybackSession",
  "export interface V5GCocosCyclicSelectionItem",
  "export interface V5GCocosCyclicSelectionController",
  ...
  "export function createVNICyclicMotionSnapshot",
  "export function advanceVNICyclicContinuousMotion",
  "export function createVNICyclicResolvePlan",
